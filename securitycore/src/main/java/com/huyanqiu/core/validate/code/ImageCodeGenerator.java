...
public class ImageCodeGenerator implements ValidateCodeGenerator{
    ...
    public ImageCode generator(ServletWebRequest request) {
        ...
        g.dispose();
        return new ImageCode(image, sRand, ServletRequestUtils.getIntParameter(request.getRequest(), "expireIn", securityProperties.getCode().getImage().getExprieIn()));
    }
